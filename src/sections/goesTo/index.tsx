...
const GoesTo: FC = () => (
	<section className={s.section} id={"2"}>
		<h1>КОМУ ПІДІЙДЕ</h1>
		<div className={s.block}>
			<IoSchoolSharp size={56} color={"#ff914d"} />
			<h3 className={s.subtitle}>ВИКЛАДЧАМ ВОКАЛУ</h3>
			<p>
				Які хочуть отримати нові, цікаві та ефективні вправи для себе та своїх
				учнів
			</p>
		</div>
		<div className={s.block}>
			...
			<p>
				Які хочуть свідомо прокачувати свій вокал з максимальною користю та
				насолодою
			</p>
		</div>
		<div className={s.block}>
