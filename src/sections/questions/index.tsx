						...
						<div className={s.question}>
							<details className={s.details}>
								...
								<p>
									...
									до телеграм-бота. Дотримуючись простих інструкцій, Ви з
									легкістю зможете придбати збірку.
								</p>
							</details>
							<details className={s.details}>
							...
							<details className={s.details}>
								...
								<p>
									Збірка доступна в електронному форматі (PDF). Вона також
									включає 26 музичних файлів (мінуси та демонстрації вправ). Все
									це знаходиться в закритому телеграм-каналі, доступ до якого Ви
									отримаєте після оплати. За бажанням Ви можете оформити
									передзамовлення друкованого збірника з доплатою 350 грн.
								</p>
							</details>
							<details className={s.details}>
								<summary className={s.summary}>
