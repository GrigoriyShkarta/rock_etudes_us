						...
						<div className={s.question}>
							...
							<details className={s.details}>
								...
								<p>
									...
									включає 26 музичних файлів (мінуси та демонстрації вправ) і 1
									бонусний відео-урок. Все це знаходиться в закритому
									телеграм-каналі, доступ до якого Ви отримаєте після оплати.
								</p>
							</details>
							<details className={s.details}>
								<summary className={s.summary}>
