...
const WhatEnter: FC = () => (
	<section className={s.section} id={"3"}>
		<h1>ЩО ВХОДИТЬ</h1>
		<div className={s.container}>
			<div className={s.block}>
				<MdOutlineDone size={40} />
				<p className={s.text}>
					13 вправ на кожну структуру голосового апарату в різних рок-стилях
				</p>
			</div>
			<div className={s.block}>
				<MdOutlineDone size={40} />
			...
			<div className={s.block}>
				<MdOutlineDone size={40} />
				<p className={s.text}>
					Базова теорія та навідні вправи на роботу кожної структури голосового
					апарату
				</p>
			</div>
			<div className={s.block}>
